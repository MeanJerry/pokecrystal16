...
MoveDescriptions1:
	...
	dw BurningJealousyDescription
	dw BuzzyBuzzDescription
	...
	dw GlareDescription
	dw GlitzyGlowDescription
	dw GrassKnotDescription
	dw GrassPledgeDescription
	...
	dw SparkDescription
	dw SparklySwirlDescription
	dw SpiderWebDescription
	dw SpikeCannonDescription
	dw SpikesDescription
	dw SpiteDescription
	dw SplashDescription
	dw SplishySplashDescription
	dw SporeDescription
...
AerialAceDescription:
	db   "High speed strike"
	next "that can not miss.@"
...
AquaTailDescription:
	db   "Attacks with tail"
	next "like vicious wave.@"

ArmThrustDescription:
	db   "Straight-arm punch"
	next "to hit 2-5 times.@"

AromaticMistDescription:
...
BouncyBubbleDescription:
	db   "WIP Eevee Only"
	next "WIP Eevee Only@"

BranchPokeDescription:
	db   "Attacks target"
	next "with sharp branch.@"

BraveBirdDescription:
	db   "A swoop that also"
	next "hurts the user.@"

BreakingSwipeDescription:
	db   "Strikes with tail"
	next "and lowers attack.@"
...
BrutalSwingDescription:
	db   "User swings viole-"
	next "ntly to do damage.@"
...
BugBuzzDescription:
	db   "User vibrate wings"
	next "may lower SPCL.DEF@"
...
BurningJealousyDescription:
	db   "Hits foe and has"
	next "high burn rate.@"

BuzzyBuzzDescription:
	db   "WIP Eevee Only"
	next "WIP Eevee Only@"
...
DragonHammerDescription:
	db   "Uses body like a"
	next "hammer to attack.@"

DragonPulseDescription:
	db   "Attack with shock"
	next "wave from mouth.@"
...
DragonRushDescription:
	db   "Strong attack. May"
	next "cause flinching.@"

DragonTailDescription:
	db   "Knock away target"
	next "ending the battle.@"
...
DualChopDescription:
	db   "Hits foe with two"
	next "brutal strikes.@"

DualWingbeatDescription:
	db   "Slams foe twice"
	next "with wing strikes.@"
...
ExpandingForceDescription:
	db   "Damages foes with"
	next "psychic powers.@"
...
FireFangDescription:
	db   "May cause a flinch"
	next "or a burn.@"

FirePledgeDescription:
	db   "WIP"
	next "WIP@"
...
FlatterDescription:
	db   "Confuse target bo-"
	next "ost their SPCL.ATK@"

FloatyFallDescription:
	db   "WIP Pikachu Only"
	next "WIP Pikachu Only@"
...
FreezeDryDescription:
	db   "May freeze foe."
	next "Strong on water.@"

FreezingGlareDescription:
	db   "Uses psychic power"
	next "may freeze foe.@"

FreezyFrostDescription:
	db   "WIP Eevee Only"
	next "WIP Eevee Only@"
...
GrassPledgeDescription:
	db   "WIP"
	next "WIP@"

GrassWhistleDescription:
	db   "Lulls the foe into"
	next "sleeping.@"
...
PowerGemDescription:
	db   "User attacks with"
	next "stone-like light.@"

PowerWhipDescription:
	db   "User violently "
	next "strikes with vines@"
...
TearfulLookDescription:
	db   "Lowers both of the"
	next "foe's ATTACK stats@"
...
WorkUpDescription:
	db   "Raises both of the"
	next "user's ATK stats.@"
